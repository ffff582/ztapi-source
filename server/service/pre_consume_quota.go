...
func ReturnPreConsumedQuota(c *gin.Context, relayInfo *relaycommon.RelayInfo) {
	refundInfo, quota := snapshotPreConsumedQuotaReturn(relayInfo)
	if quota != 0 {
...
func snapshotPreConsumedQuotaReturn(relayInfo *relaycommon.RelayInfo) (*relaycommon.RelayInfo, int) {
	if relayInfo == nil {
		return nil, 0
	}
	return &relaycommon.RelayInfo{
		...
		TokenKeyHash:   relayInfo.TokenKeyHash,
