...
async function requestUSDTTopUp({ method, url, body }) {
...
const TopUp = () => {
  ...
  const [enableUSDTTRC20TopUp, setEnableUSDTTRC20TopUp] = useState(false);
  const [usdtTRC20MinTopUp, setUSDTTRC20MinTopUp] = useState(10);
  const [usdtTRC20OrderTTL, setUSDTTRC20OrderTTL] = useState(600);
    ...
    try {
      ...
      if (success) {
        ...
        try {
          ...
          setEnableUSDTTRC20TopUp(enableUSDTTRC20TopUp);
          setUSDTTRC20MinTopUp(Number(data.usdt_trc20_min_topup) || 10);
          setUSDTTRC20OrderTTL(
            Number(data.usdt_trc20_order_ttl_seconds) || 600,
          );
    ...
    <div className='w-full max-w-7xl mx-auto relative min-h-screen lg:min-h-0 mt-[60px] px-2'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        <RechargeCard
          ...
          enableUSDTTRC20TopUp={enableUSDTTRC20TopUp}
          usdtTRC20MinTopUp={usdtTRC20MinTopUp}
          usdtTRC20OrderTTL={usdtTRC20OrderTTL}
          usdtRequest={requestUSDTTopUp}
          onUSDTSettled={getUserQuota}
        />
        <InvitationCard
          t={t}
          userState={userState}
