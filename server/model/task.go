...
type TaskPrivateData struct {
	...
	// ZTAPI media tasks use the durable settlement state machine. These fields
	// prevent legacy polling code from mutating their balances.
	ZTAPIMediaManaged      bool `json:"ztapi_media_managed,omitempty"`
	ZTAPIMediaSettlementID uint `json:"ztapi_media_settlement_id,omitempty"`
