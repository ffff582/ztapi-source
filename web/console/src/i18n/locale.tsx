...
const english: Record<string, string> = {
  ...
  '立即开始': 'Get started',
  '充值福利': 'Top-up bonus',
  '充值即赠 5% 使用额度': 'Get 5% extra usage credit on every top-up',
  '充值 100 U，到账可用 105 U': 'Top up 100 U and receive 105 U in usable credit',
  '联系 Telegram 客服': 'Contact Telegram support',
  '概览': 'Overview',
  'API 密钥': 'API keys',
  '模型支持': 'Supported models',
  '综合优惠约 20%': 'Save about 20% overall',
  '模型价格对比官方更优惠，充值再额外赠送 5% 使用额度。': 'Lower model prices than official rates, plus 5% extra usage credit on every top-up.',
  '价格对比': 'Price comparison',
  '规格': 'Specification',
  '我们的价格': 'Our price',
  '官方价格': 'Official price',
  '节省': 'Savings',
  '节省 {{percent}}%': 'Save {{percent}}%',
  '查看价格对比': 'Compare prices',
  '在线测试': 'Online test',
  '使用说明': 'Integration guide',
  '开发者文档': 'Developer documentation',
  '查看统一鉴权方式、公开端点和请求规范。': 'Review authentication, public endpoints, and request conventions.',
  '基础信息': 'Basics',
  '公开端点': 'Public endpoints',
  '方法': 'Method',
  '路径': 'Path',
  '用途': 'Purpose',
  '获取当前可用模型': 'List currently available models',
  'OpenAI 兼容对话': 'OpenAI-compatible chat',
  'Responses 模型调用': 'Responses model requests',
  '生成文本向量': 'Create text embeddings',
  '生成图片': 'Generate images',
  '创建视频任务': 'Create a video task',
  '查询视频任务': 'Retrieve a video task',
  '最小请求示例': 'Minimal request example',
  '保留现有 OpenAI SDK，只替换 Base URL、API Key 和模型 ID。': 'Keep your OpenAI SDK and replace only the Base URL, API key, and model ID.',
  '登录控制台创建密钥，密钥只完整展示一次。': 'Create a key in the console. The full key is shown only once.',
  '在模型支持页复制准确的 ZTAPI 模型名称。': 'Copy the exact ZTAPI model name from Supported models.',
  '替换连接信息': 'Replace connection settings',
  '将 SDK 的 Base URL 改为 ZTAPI，再发送第一条请求。': 'Point your SDK Base URL to ZTAPI, then send your first request.',
  'Python 示例': 'Python example',
  '选择正确的接口': 'Choose the correct endpoint',
  '按模型支持页标注的调用地址接入': 'Use the endpoint shown on Supported models',
  'Responses-only 模型使用 /v1/responses；图片和视频模型使用各自的专用端点。': 'Responses-only models use /v1/responses; image and video models use their dedicated endpoints.',
  '账户使用': 'Account usage',
  '从注册、充值到查看调用费用，按顺序完成首次使用。': 'Follow the first-use flow from registration and top-up to reviewing request costs.',
  '首次使用流程': 'First-use flow',
  '注册与登录': 'Register and sign in',
  '注册只需账号和密码，邮箱可稍后补充并用于找回密码。': 'Register with a username and password. Add an email later for password recovery.',
  '充值余额': 'Add balance',
  '创建 USDT 订单后按页面金额和地址付款，到账后自动入账并额外赠送 5% 使用额度。': 'Create a USDT order and pay the exact amount to the displayed address. Confirmed payments receive an extra 5% usage credit.',
  '进入 API 密钥页面创建密钥并立即保存，后续无法再次查看完整密钥。': 'Create and immediately save a key from API keys. The full key cannot be viewed again.',
  '选择模型': 'Choose a model',
  '在模型支持页查看当前可用模型、调用端点与实时售价。': 'Review available models, endpoints, and live prices on Supported models.',
  '查看消费': 'Review charges',
  '使用日志会记录模型、输入输出用量、费用、请求状态与时间。': 'Usage logs show the model, input and output usage, charge, status, and time.',
  '安全提醒': 'Security notice',
  '不要公开 API Key': 'Never expose your API key',
  '请把密钥放在服务端环境变量中，不要写入网页、安装包、聊天记录或公开仓库。': 'Store keys in server-side environment variables, never in webpages, app packages, chats, or public repositories.',
  '问题排查': 'Troubleshooting',
  '先按错误信息自查；仍无法解决时带上请求编号联系客服。': 'Check the error first. If it persists, contact support with the request ID.',
  '常见问题与处理方式': 'Common issues and fixes',
  '需要帮助？': 'Need help?',
  '请求返回 401 怎么办？': 'What should I do when a request returns 401?',
  '检查 Authorization 是否为 Bearer 加空格再加 API Key，并确认密钥未被删除或禁用。': 'Check that Authorization contains Bearer, a space, and your API key. Confirm that the key is active.',
  '提示模型不存在或不可用怎么办？': 'What if the model does not exist or is unavailable?',
  '不要手写模型名称，请从模型支持页复制模型 ID，并确认使用了该模型标注的接口。': 'Copy the model ID from Supported models and use the endpoint shown for that model.',
  '返回 429 是什么意思？': 'What does 429 mean?',
  '请求过于频繁或上游线路限流。降低并发后重试；持续出现时联系 Telegram 客服并提供请求编号。': 'The request rate or upstream route is limited. Reduce concurrency and retry. Contact Telegram support with the request ID if it persists.',
  '返回 5xx 或空内容怎么办？': 'What should I do with a 5xx or empty response?',
  '先用相同参数重试一次。若仍失败，请提供模型名、发生时间和请求编号，切勿发送 API Key。': 'Retry once with the same parameters. If it still fails, provide the model, time, and request ID, but never your API key.',
  '充值后为什么没有立刻到账？': 'Why was my top-up not credited immediately?',
  '订单有效期内按唯一金额付款。链上确认后系统自动入账；超时仍未到账请提供订单号和交易哈希。': 'Pay the exact unique amount before the order expires. It is credited after confirmation; provide the order ID and transaction hash if delayed.',
  '费用是怎样计算的？': 'How are charges calculated?',
  '以模型支持页的实时售价和上游返回的实际用量为准，使用日志中可查看每次调用费用。': 'Charges use the live price on Supported models and actual upstream-reported usage. Each charge appears in Usage logs.',
  'API Key 忘记了怎么办？': 'What if I lose my API key?',
  '完整密钥只展示一次。无法找回时请删除旧密钥并创建新密钥。': 'The full key is shown once. Delete the old key and create a new one if it is lost.',
  '使用日志': 'Usage logs',
  '余额充值': 'Add funds',
  ...
  '输入注册邮箱，我们会发送一个 10 分钟内有效的重置链接。': 'Enter your registered email and we will send a reset link valid for 10 minutes.',
  '邮箱': 'Email',
  '邮箱验证码': 'Email verification code',
  '发送验证码': 'Send code',
  '重新发送': 'Send again',
  '请填写有效邮箱和邮箱验证码': 'Enter a valid email and verification code.',
  '请输入有效的邮箱地址': 'Enter a valid email address.',
  '发送中...': 'Sending...',
  '发送重置邮件': 'Send reset email',
  '如果该邮箱已绑定账号，重置邮件将在几分钟内送达。': 'If an account is linked to this email, a reset message will arrive within a few minutes.',
  '返回登录': 'Back to sign in',
  '设置新密码': 'Set a new password',
  '设置新密码后，其他设备上的登录状态会自动失效。': 'After you set a new password, sessions on other devices will be signed out.',
  '新密码': 'New password',
  '确认新密码': 'Confirm new password',
  '两次输入的密码不一致': 'The passwords do not match.',
  '修改中...': 'Updating...',
  '确认修改': 'Update password',
  '密码已更新，请重新登录。': 'Your password has been updated. Sign in again.',
  '重置链接无效或已过期。': 'This reset link is invalid or has expired.',
  '还没有账号？': 'New to ZTAPI?',
  '创建账号': 'Create account',
  '创建账号后即可进入控制台并生成 API Key。': 'Create an account to access the console and generate an API key.',
  '邮箱（选填）': 'Email (optional)',
  '可在注册后验证，用于找回密码。': 'Verify it after registration to enable password recovery.',
  '验证码': 'Verification code',
  '刷新验证码': 'Refresh verification code',
  '验证码图片': 'Verification code image',
  '验证码加载失败，请点击刷新': 'Verification code failed to load. Click to retry.',
  '看不清可以点击图片换一张': 'Click the image to get a new code.',
  '请输入图中的验证码': 'Enter the verification code shown in the image.',
  ...
  '补充并验证邮箱后，可通过邮件找回密码。未验证邮箱不能用于重置密码。': 'Add and verify an email to recover your password. Unverified addresses cannot reset it.',
  '登录邮箱': 'Account email',
  '正在加载账号信息...': 'Loading account information...',
  '账号信息加载失败，请刷新后重试。': 'Account information could not be loaded. Refresh and try again.',
  '邮箱地址': 'Email address',
  '邮箱已验证，可用于找回密码。': 'Email verified and available for password recovery.',
  '更换邮箱时，原邮箱会保留到新邮箱验证成功。': 'Your current email remains active until the new address is verified.',
  '验证码发送成功后，再输入验证码完成绑定。': 'Enter the verification code after it is sent to finish linking the email.',
  '验证码发送失败，请确认邮箱未被其他账号使用后重试。': 'The code could not be sent. Confirm the email is not used by another account and try again.',
  '邮箱绑定失败，请检查验证码是否正确或重新发送。': 'The email could not be linked. Check the code or send a new one.',
  '确认绑定': 'Verify and link',
  '创建中...': 'Creating...',
  ...
  '首次接入进度': 'First integration progress',
  '完成首次接入': 'Complete your first integration',
  '{{count}} / 4 已完成': '{{count}} of 4 completed',
  '选择并测试模型': 'Choose and test a model',
  '发送首个请求': 'Send your first request',
  '查看费用日志': 'Review billing logs',
  '查看': 'View',
  '去完成': 'Continue',
  ...
  '日志筛选': 'Log filters',
  '模型筛选': 'Model filter',
  '输入完整模型 ID': 'Enter the full model ID',
  '结果筛选': 'Result filter',
  '全部结果': 'All results',
  '仅成功': 'Success only',
  '仅失败': 'Failed only',
  '请求 ID 筛选': 'Request ID filter',
  '筛选': 'Filter',
  '清除筛选': 'Clear filters',
  '模型暂不可用': 'Model temporarily unavailable',
  '余额不足': 'Insufficient balance',
  '请求频率过高': 'Request rate too high',
  '模型未返回有效内容': 'The model returned no valid content',
  '请求失败，请根据请求 ID 联系支持': 'Request failed. Contact support with the request ID.',
  ...
  '立即测试': 'Test now',
  '测试': 'Test',
  '接入验证': 'Integration check',
  '在线 API 测试': 'Online API test',
  '用当前账号真实调用模型，确认模型、余额、计费和返回结果是否正常。': 'Make a real request with this account to verify the model, balance, billing, and response.',
  '发送测试请求': 'Send test request',
  '计费提醒': 'Billing notice',
  '本次测试会按正常 API 请求扣费': 'This test is billed as a normal API request',
  '请求会经过正式模型线路，并在使用日志中留下费用记录。': 'The request uses the production model route and creates a charge record in usage logs.',
  '正在加载可测试模型...': 'Loading testable models...',
  '可测试模型加载失败，请刷新后重试。': 'Testable models could not be loaded. Refresh and try again.',
  '当前账号暂无可在线测试的文本模型。': 'This account has no text models available for online testing.',
  '测试模型': 'Test model',
  '测试问题': 'Test prompt',
  '{{count}} / 4000 字符': '{{count}} / 4000 characters',
  '正在调用...': 'Sending...',
  '余额不足，请先充值后再测试。': 'Your balance is insufficient. Add funds before testing.',
  '当前模型暂不可用，请更换模型或稍后再试。': 'This model is temporarily unavailable. Choose another model or try again later.',
  '请求较多，请稍后再试。': 'Too many requests. Try again shortly.',
  '登录状态已失效，请重新登录。': 'Your session has expired. Sign in again.',
  '测试请求失败，请稍后重试。': 'The test request failed. Try again later.',
  '调用结果': 'Request result',
  '发送请求后，模型回答和本次费用会显示在这里。': 'The model response and charge will appear here after you send a request.',
  '本次费用': 'Request charge',
  '入账中': 'Posting',
  '页面耗时': 'Elapsed time',
  '结束原因': 'Finish reason',
  '在使用日志中查看': 'View in usage logs',
  '接入代码': 'Integration code',
  '把相同模型接入你的程序': 'Use the same model in your application',
  ...
  '充值规则': 'Top-up rules',
  '充值优惠': 'Top-up offer',
  '充值额外赠送 5%': 'Get 5% extra credit on every top-up',
  '赠送额度自动到账，可用于调用全部已上架模型。': 'Bonus credit is added automatically and can be used for every published model.',
  '充值 {{amount}} U，实际到账 {{total}} U': 'Top up {{amount}} U and receive {{total}} U in total',
  '充值赠送': 'Top-up bonus',
  '其中赠送 {{amount}} U': 'Includes {{amount}} U bonus',
